...
from repositories.storage.aliyun_oss_storage import AliyunOssStorage


@pytest.mark.asyncio
async def test_local_fs_storage():
    aliyun_oss_config = app_config.repository.storage.aliyun_oss
    storage = AliyunOssStorage(**aliyun_oss_config)
