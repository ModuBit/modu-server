...
def dumps(obj,
    ...
    return json.dumps(obj,
                      ...
                      encoding=encoding, default=default or custom_serializer, use_decimal=use_decimal,
                      ...
                      for_json=for_json, ignore_nan=ignore_nan, int_as_string_bitcount=int_as_string_bitcount,
                      iterable_as_array=iterable_as_array, **kw)
...
def loads(s,
    ...
    return json.loads(s,
                      encoding=encoding, cls=cls, object_hook=object_hook or custom_deserializer,
                      parse_float=parse_float, parse_int=parse_int, parse_constant=parse_constant,
                      object_pairs_hook=object_pairs_hook, use_decimal=use_decimal, allow_nan=allow_nan, **kw)
